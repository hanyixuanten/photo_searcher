...
<body>
    ...
    <div id="div1" style="display:flex; justify-content:center; align-items:center;height:100vh;"><!-- 搜索框 -->
        <div id="div2">
            ...
            <input name="inputs" type="text" id="inputs"
                style="padding:5px; border-radius:5px; border:none; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75);"></input>
            <form id="form1" target="show" method="post" action="search.php">
                <input type="text" id="base64" name="inputs" style="display: none;"></input>
                <button id="fun" type="submit"
                    style="margin-top:10px; padding:5px 10px; border-radius:5px; border:none; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75); background-color:#4CAF50; color:white;">Submit</button>
                <br><br>
                <label for="num" style="margin-bottom:10px;">搜索数量:</label>
                <input name="num" type="number" id="num"
                    style="padding:5px; border-radius:5px; border:none; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75);"
                    min="10" max="1000" value="50"></input>
                <br>
